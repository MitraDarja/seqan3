...
using underlying_range_types = ::testing::Types<std::vector<seqan3::dna4>,
                                                ...
                                                // can be commented in as soon as issue #1743 is solved
...
protected:
    ...
    result_t ungapped3{26, 97, 6, 1}; // ACGG, CGAC, aacg, aaac
    result_t gapped3{2, 5, 2, 1};     // A--G, C--C, a--g, a--c "-" for gap
};
...
TEST_F(minimiser_hash_test, ungapped)
{
    ...
    // can be commented in as soon as issue #1745 is solved
