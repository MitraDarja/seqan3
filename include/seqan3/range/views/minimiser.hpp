...
template <std::ranges::view urng1_t,
          std::ranges::view urng2_t = ranges::empty_view<seqan3::detail::empty_type>>
...
private:
    ...
    using default_urng2_t = ranges::empty_view<seqan3::detail::empty_type>;
...
struct minimiser_fn
{
    ...
    constexpr auto operator()(urng1_t && urange1, size_t const & window_values_size,
                              urng2_t && urange2) const
    {
        static_assert(std::ranges::viewable_range<urng1_t>,
