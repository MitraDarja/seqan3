 ...
 */
template <std::ranges::view first_urange_t, typename second_urange_t = std::ranges::empty_view<seqan3::detail::empty_type>>
...
>>>>>>> [MISC] Rename ranges and range types
    ...
    */
    window_iterator(first_it_t it_start, sentinel_t it_end, second_it_t it_start2, uint32_t window_values_size) :
        first_range_end{it_end}, window_right{it_start}, window_right2{it_start2}
    {
...
struct minimiser_fn
{
    ...
    constexpr auto operator()(first_urange_t && first_range, uint32_t const & window_values_size, second_urange_t && second_range) const
    {
        static_assert(std::ranges::viewable_range<first_urange_t>,
            "The range parameter to views::minimiser cannot be a temporary of a non-view range.");
        static_assert(std::ranges::forward_range<first_urange_t>,
